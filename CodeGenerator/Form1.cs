using CoraxwidePro.Core.Entities.Abstract;
using CoraxwidePro.Entities.Concrete;
using System;
using System.IO;
using System.Linq;
...
namespace CodeGenerator
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //txtContextName.Text = directory.Name + "Context";
            txtContextName.Text = "CoraxwideProContext";

            foreach (string dir in dirs)
            {
                txtEntitiesPath.Text = dir + @"\Concrete\";
            }

            DirectoryInfo entityInfo = new DirectoryInfo(txtEntitiesPath.Text);
            ...
            if (directory != null)
            {
                txtProjectPath.Text = directory.FullName;
            }
        }
    ...
    public class SqlServerHelper : NHibernateHelper
    {
        protected override ISessionFactory InitializeFactory()
        {
            return Fluently.Configure().Database(MsSqlConfiguration.MsSql2012
                .ConnectionString(c => c.FromConnectionStringWithKey(" + txtContextName.Text + @")))
...
";
        ...
        public void CreateDataAccessNhibernateMapFiles()
        {
            ...
            foreach (var type in typeof(User).Assembly.GetTypes())
            {
                ...
                if (t != null && t.Length > 0 && t[0] != typeof(IBaseEntity)) continue;
                gen.Add(type);
            }
...
{
    public class " + txtContextName.Text + @":DbContext
    {
        public " + txtContextName.Text + @"()
        {
               Database.SetInitializer<" + txtContextName.Text +
                             @">(null/*new CreateDatabaseIfNotExists<" + txtContextName.Text + @">()*/);
        }" + Environment.NewLine;
            DirectoryInfo entityInfo = new DirectoryInfo(txtEntitiesPath.Text);
            foreach (var item in entityInfo.GetFiles())
            {
...
";
            ...
            File.WriteAllText(path + txtContextName.Text + ".cs", text2write, System.Text.Encoding.UTF8);
        }
        ...
        public void CreateDataAccessEfConcreteFiles()
        {
            ...
            {
                MessageBox.Show("CreateDataAccessEfConcreteFiles Metdounda Hata: " + ex.ToString());
            }
        }
...
";
        ...
        private void CreateMvcUiListViews()
        {
            ...
            var typess = typeof(User).Assembly.GetTypes();
...
";
        ...
        private void btnGenerator_Click(object sender, EventArgs e)
        {
            ...
            CreateController();
            MessageBox.Show("Dosyalar Oluşturuldu.\r\nDataAccess,Business ve MVC Katmanları Oluşturuldu.");
        ...
        private void btnProjectPath_Click(object sender, EventArgs e)
        {
            ...
            txtProjectPath.Text = secilenDizin; //Proje Yolu
        }
        ...
        private void btnEntityPath_Click(object sender, EventArgs e)
        {
            ...
            fBrowser.ShowDialog();
            string secilenDizin = fBrowser.SelectedPath;
            txtEntitiesPath.Text = secilenDizin; //Entity Yolu
        }
    }
}